	...
	<div class="container">
		...
		<div class="data-tables datatable-dark">
			<table class="display" id="dataTable3" style="width:100%">
				...
				<tbody>
					<?php 
					$brg=mysqli_query($conn,"SELECT * FROM tb_barang_keluar tbk, tb_barang tb WHERE tbk.id_barang = tb.id_barang ORDER BY tbk.id_keluar ASC");
					$no=1;
