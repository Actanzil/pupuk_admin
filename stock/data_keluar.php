                ...
                <div class="card-footer px-3 border-0 d-flex flex-column flex-lg-row align-items-center justify-content-between">
                    <nav aria-label="Page navigation example">
                        ...
                        <?php
                            ...
                            if ($halaman > 1) {
                                echo '<li class="page-item"><a class="page-link" href="data_keluar.php?halaman=' . ($halaman - 1) . '"><i class="bi bi-chevron-left"></i></a></li>';
                            }

                            for ($i = 1; $i <= $total_halaman; $i++) {
                                echo '<li class="page-item ' . ($i == $halaman ? 'active' : '') . '"><a class="page-link" href="data_keluar.php?halaman=' . $i . '">' . $i . '</a></li>';
                            }

                            if ($halaman < $total_halaman) {
                                echo '<li class="page-item"><a class="page-link" href="data_keluar.php?halaman=' . ($halaman + 1) . '"><i class="bi bi-chevron-right"></i></a></li>';
                            }
                            ?>
                        </ul>
                    </nav>
